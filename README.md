...
- **Add a publication** — copy a `pub-entry` block in `publications.html`, set the correct `data-type`, and fill in the details.
- **Update CV sections** — edit `index.html` directly.
- Changes go live within a few minutes of pushing to `main`.
